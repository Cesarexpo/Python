...
class webinar:
    ...
    def __init__(self):
        self.webinar_identifier = webinar_identifier

    def retrieve_var(self, webinar_identifier):
        ...
        print(webinartitle, presenter, date, time, industrytechnique, registration_sales,
              whoshouldattend, brc, webinar_identifier, overview, registrantstotal, attendees)
