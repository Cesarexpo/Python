...
def submit_blazing_hot():
    ...
    message.Attachments.Add(r"C:\Users\coron\Desktop\Project Charter - Blazing Hot.xlsx")
    html_body = """
        <div>
...
def submit_toasty_warm():
    ...
    message.Attachments.Add(r"C:\Users\coron\Desktop\Project Charter - Toasty Warm.xlsx")
    html_body = """
        <div>
            <span style="font-family: 'Arial'; font-size: 12; color: #000000;">
                Dear Data Integrity Team,<br>
...
def submit_new_project():
    ...
    message.Attachments.Add(r"C:\Users\coron\Desktop\Project Charter - New Project.xlsx")
    html_body = """
        <div>
            <span style="font-family: 'Arial'; font-size: 12; color: #000000;">
                Dear Data Integrity Team,<br>
